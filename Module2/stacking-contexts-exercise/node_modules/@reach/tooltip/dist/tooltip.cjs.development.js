...
function useTooltip(_temp) {
  ...
  var _React$useState = React.useState(DEBUG_STYLE ? true : id === null ? false : context.id === id && state === VISIBLE),
...
var Tooltip = /*#__PURE__*/utils.forwardRefWithAs(function (_ref2, forwardedRef) {
  ...
  var child = React.Children.only(children);
   utils.warning(!DEPRECATED_ariaLabel, "The `ariaLabel prop is deprecated and will be removed from @reach/tooltip in a future version of Reach UI. Please use `aria-label` instead.") ; // We need to pass some properties from the child into useTooltip
  ...
  return React.createElement(React.Fragment, null, React.cloneElement(child, trigger), React.createElement(TooltipPopup, Object.assign({
    ref: forwardedRef,
    label: label,
...
var TooltipPopup = /*#__PURE__*/utils.forwardRefWithAs(function TooltipPopup(_ref3, forwardRef) {
  ...
  return isVisible ? React.createElement(portal.Portal, null, React.createElement(TooltipContent, Object.assign({
    ref: forwardRef,
    label: label,
    "aria-label": DEPRECATED_ariaLabel,
    isVisible: isVisible
...
var TooltipContent = /*#__PURE__*/utils.forwardRefWithAs(function TooltipContent(_ref4, forwardedRef) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Comp, Object.assign({
  ...
  }), label), hasAriaLabel && React.createElement(visuallyHidden.VisuallyHidden, {
    role: "tooltip",
    id: id
